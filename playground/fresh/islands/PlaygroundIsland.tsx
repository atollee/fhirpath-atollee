...
const getCategorizedExpressions = (t: Translations) => ({
  ...
  [t.sampleCategories.conversion]: [
    ...
    { label: "convertsToDate()", expr: "'2024-01-15'.convertsToDate()" },
    { label: "convertsToDateTime()", expr: "'invalid'.convertsToDateTime()" },
    { label: "convertsToTime()", expr: "'14:30'.convertsToTime()" },
    { label: "convertsToQuantity()", expr: "'5 kg'.convertsToQuantity()" },
  ...
  [t.sampleCategories.utility]: [
    ...
    { label: "%context", expr: "%context" },
    { label: "%ucum", expr: "%ucum" },
  ],
});
